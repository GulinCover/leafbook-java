...
public class ArticleRelatedControllerRpc {
    ...
    public int postInsertLinkNextArticleInfoRpc(@RequestParam("articleId")Long articleId,@RequestParam("nextArticleId")Long nextArticleId) {
        return articleRelatedServiceRpc.postInsertLinkNextArticleInfo(articleId,nextArticleId);
    }
    ...
    public int postUpdateLinkNextArticleInfoRpc(@RequestParam("articleId")Long articleId,@RequestParam("nextArticleId")Long nextArticleId) {
        return articleRelatedServiceRpc.postUpdateLinkNextArticleInfo(articleId,nextArticleId);
    }
