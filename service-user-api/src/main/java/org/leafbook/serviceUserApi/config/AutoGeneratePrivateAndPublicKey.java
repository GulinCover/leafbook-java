...
public class AutoGeneratePrivateAndPublicKey {
    ...
    static {
        try {
            ...
            RSAPrivateKeySpec privateKeySpec = new RSAPrivateKeySpec(new BigInteger(1,mod),new BigInteger(1,exp));
            RSAPublicKeySpec publicKeySpec = new RSAPublicKeySpec(new BigInteger(1,mod),new BigInteger(1,modPriv));
